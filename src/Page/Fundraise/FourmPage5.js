            ...
            <Width>
                    ...
                    <Left>
                        ...
                        <Margin>
                            {/* <T>3 of 4</T> */}
                            <H style={{color:'#000'}}>
                            Any documents you want to upload to support your fundraiser
                            </H>
                        </Margin>
                    </Left>
                        ...
                        <Back style={{display:'flex',alignItems:'flex-end',justifyContent:'flex-end'}}>
                          ...
                          <Details>
                            ...
                            <div style={{display:'grid',placeItems:'center'}}>
                                <Button style={{borderRadius:'2rem',width:'9rem',margin:'1rem 0',border:'2px solid #FFFFFF',fontSize:'2rem'}}
                                    onClick={() => dispatch({type:'F7'}) }
                                >
                                    Next
                                </Button>
                            </div>
