  ...
  const options = [
    {
        label: <span style={{color:'#02A95C',display:'flex',alignItems:'center'}}>
            ...
            <span style={{fontSize:'1.6rem',margin:'0 0 0 0.5rem'}}>About</span>
            </span>,
        value: {
             foo: true
        },
    ...
    },
    {
        ...
        <span style={{fontSize:'1.6rem',margin:'0 0 0 0.5rem'}}>Update</span>
        </span>
        ,
        value: "bar",
        selectedBackgroundColor: "rgba(251, 216, 155, 1.00)"
    },
    {
        ...
        <span style={{fontSize:'1.6rem',margin:'0 0 0 0.5rem'}}>Related files</span>
        </span>
        ,
        value: "bar",
        selectedBackgroundColor: "rgba(251, 216, 155, 1.00)"
