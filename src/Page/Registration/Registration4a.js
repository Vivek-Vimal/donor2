            ...
            <Width>
                <Box>
                    ...
                    <Right>
                        ...
                        <Details>
                            <div style={{width:'100%'}}>
                             <H style={{fontSize:'1.5rem',color:'#FFF',textAlign:'left',margin:'0 0 2rem 1rem'}}>Residence proof document</H>
                            </div>
                            <Flex>

                                <div>
                                    
                                        <H style={{margin: "0 0 0.5rem 0.25rem",color:' #FFF' }}>
                                            Document type
                                        </H>
