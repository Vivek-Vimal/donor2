                    ...
                    <Right>
                        ...
                        <Container>
                            <div>
                                ...
                                <input type="Number" placeholder="Your goal amount"  className="input1" style={{height:"4rem",border:'1px solid rgba(0,0,0,0.2)',borderRadius:'0.5rem',width:'80%',margin:'0.5rem 0 0 0'}} />
                            </div>    
                            ...
                            <Flex>
                                <div>
                                    ...
                                    <input type="Number" placeholder="Your goal amount"  className="input1" style={{height:"4rem",border:'1px solid rgba(0,0,0,0.2)',borderRadius:'0.5rem',width:'25rem',margin:'0.5rem 0 0 0'}} />
                                </div> 
                                <div>
                                    <T style={{margin:'0 0 0 0',fontSize:'1.5rem',color:'#000'}}>
                                        Date Of Birth
